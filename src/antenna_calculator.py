...
class AntennaCalculator:
    def __init__(self, a=None):
        main_parser = argparse.ArgumentParser(
            description="Antenna Calculator", add_help=False
        )
        ...
        # RECTANGULAR PATCH
        rectangular_patch_subparser = subparsers.add_parser(
            "rectangular_patch", add_help=False
        )
        rectangular_patch_subparser.add_argument(
            "--help",
            action="help",
            default=argparse.SUPPRESS,
            help="Show this help message and exit",
        ...
        rectangular_patch_subparser.add_argument(
            "--type",
            type=str,
            choices=["microstrip", "probe"],
            default="microstrip",
            help="Type of patch",
        )
        rectangular_patch_subparser.add_argument(
            "-f", "--frequency", type=float, required=True, help="Frequency in Hz"
        )
        rectangular_patch_subparser.add_argument(
            "-er",
        ...
        rectangular_patch_subparser.add_argument(
            "--dxfoutput", type=str, required=False, help="Name of .dxf file"
        )
        rectangular_patch_subparser.add_argument(
            "--gerberoutput",
            type=str,
        ...
        rectangular_patch_export_subparser = subparsers.add_parser(
            "rectangular_patch_export", add_help=False
        )
        rectangular_patch_export_subparser.add_argument(
            "--help",
            action="help",
            default=argparse.SUPPRESS,
            help="Show this help message and exit",
        ...
        rectangular_patch_export_subparser.add_argument(
            "-W", "--width", type=float, required=True, help="width in meters"
        )
        rectangular_patch_export_subparser.add_argument(
            "-L", "--length", type=float, required=True, help="length in meters"
        )
        rectangular_patch_export_subparser.add_argument(
            "-x0", type=float, required=True, help="x0 in meters"
        )
        rectangular_patch_export_subparser.add_argument(
            "-y0", type=float, required=True, help="y0 in meters"
        )
        rectangular_patch_export_subparser.add_argument(
            "-ws",
            "--strip_width",
        ...
        # HALF WAVE DIPOLE
        half_wave_dipole_subparser = subparsers.add_parser(
            "half_wave_dipole", add_help=False
        )
        half_wave_dipole_subparser.add_argument(
            "--help",
            action="help",
            default=argparse.SUPPRESS,
            help="Show this help message and exit",
        ...
        quarter_wave_monopole_subparser = subparsers.add_parser(
            "quarter_wave_monopole", add_help=False
        )
        quarter_wave_monopole_subparser.add_argument(
            "--help",
            action="help",
            default=argparse.SUPPRESS,
            help="Show this help message and exit",
